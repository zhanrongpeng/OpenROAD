...
EXTERN int defiPinAntennaModel_APinGateArea(const defiPinAntennaModel* obj,
                                            int index);
EXTERN int defiPinAntennaModel_hasAPinGateAreaLayer(
    const defiPinAntennaModel* obj,
    int index);
EXTERN const char* defiPinAntennaModel_APinGateAreaLayer(
    const defiPinAntennaModel* obj,
    int index);

EXTERN int defiPinAntennaModel_hasAPinMaxAreaCar(
    const defiPinAntennaModel* obj);
EXTERN int defiPinAntennaModel_numAPinMaxAreaCar(
    const defiPinAntennaModel* obj);
EXTERN int defiPinAntennaModel_APinMaxAreaCar(const defiPinAntennaModel* obj,
                                              int index);
EXTERN int defiPinAntennaModel_hasAPinMaxAreaCarLayer(
    const defiPinAntennaModel* obj,
    int index);
EXTERN const char* defiPinAntennaModel_APinMaxAreaCarLayer(
    const defiPinAntennaModel* obj,
    int index);

EXTERN int defiPinAntennaModel_hasAPinMaxSideAreaCar(
    const defiPinAntennaModel* obj);
EXTERN int defiPinAntennaModel_numAPinMaxSideAreaCar(
    const defiPinAntennaModel* obj);
EXTERN int defiPinAntennaModel_APinMaxSideAreaCar(
    const defiPinAntennaModel* obj,
    int index);
EXTERN int defiPinAntennaModel_hasAPinMaxSideAreaCarLayer(
    const defiPinAntennaModel* obj,
    int index);
EXTERN const char* defiPinAntennaModel_APinMaxSideAreaCarLayer(
    const defiPinAntennaModel* obj,
    int index);
...
EXTERN int defiPinAntennaModel_APinMaxCutCar(const defiPinAntennaModel* obj,
                                             int index);
EXTERN int defiPinAntennaModel_hasAPinMaxCutCarLayer(
    const defiPinAntennaModel* obj,
    int index);
EXTERN const char* defiPinAntennaModel_APinMaxCutCarLayer(
    const defiPinAntennaModel* obj,
    int index);

EXTERN int defiPinPort_numLayer(const defiPinPort* obj);
EXTERN const char* defiPinPort_layer(const defiPinPort* obj, int index);
EXTERN void defiPinPort_bounds(const defiPinPort* obj,
                               int index,
                               int* xl,
                               int* yl,
                               int* xh,
...
EXTERN int defiPinPort_hasLayerDesignRuleWidth(const defiPinPort* obj,
                                               int index);
...
EXTERN struct defiPoints defiPinPort_getPolygon(const defiPinPort* obj,
                                                int index);
EXTERN int defiPinPort_hasPolygonSpacing(const defiPinPort* obj, int index);
EXTERN int defiPinPort_hasPolygonDesignRuleWidth(const defiPinPort* obj,
                                                 int index);
EXTERN int defiPinPort_polygonSpacing(const defiPinPort* obj, int index);
EXTERN int defiPinPort_polygonDesignRuleWidth(const defiPinPort* obj,
                                              int index);
...
EXTERN void defiPin_bounds(const defiPin* obj,
                           int index,
                           int* xl,
                           int* yl,
                           int* xh,
...
EXTERN const char* defiPin_APinPartialMetalAreaLayer(const defiPin* obj,
                                                     int index);
...
EXTERN int defiPin_hasAPinPartialMetalSideAreaLayer(const defiPin* obj,
                                                    int index);
EXTERN const char* defiPin_APinPartialMetalSideAreaLayer(const defiPin* obj,
                                                         int index);
...
EXTERN const char* defiPin_APinPartialCutAreaLayer(const defiPin* obj,
                                                   int index);

/* 5.5                                                                      */
EXTERN int defiPin_numAntennaModel(const defiPin* obj);
EXTERN const defiPinAntennaModel* defiPin_antennaModel(const defiPin* obj,
                                                       int index);
