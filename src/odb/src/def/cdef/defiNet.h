...
EXTERN void defiNet_spacingRule(const defiNet* obj,
                                int index,
                                char** layer,
                                double* dist,
                                double* left,
...
EXTERN void defiNet_widthRule(const defiNet* obj,
                              int index,
                              char** layer,
                              double* dist);
...
EXTERN const char* defiNet_polyRouteStatusShieldName(const defiNet* obj,
                                                     int index);
...
EXTERN const char* defiNet_rectRouteStatusShieldName(const defiNet* obj,
                                                     int index);
