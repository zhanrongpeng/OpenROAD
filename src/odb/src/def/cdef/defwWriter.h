...
EXTERN int defwIntPropDef(const char* objType,
                          const char* propName,
                          double leftRange,
                          double rightRange,
                          int propValue);
 ...
 * The objType can be LIBRARY or VIA or MACRO or PIN. */
/* NONDEFAULTRULE | MACRO | PIN         */
EXTERN int defwRealPropDef(const char* objType,
                           const char* propName,
                           double leftRange,
                           double rightRange,
                           double propValue);
 ...
 * The objType can be LIBRARY or VIA or MACRO or PIN. */
/* NONDEFAULTRULE | MACRO | PIN        */
EXTERN int defwStringPropDef(const char* objType,
                             const char* propName,
                             double leftRange,
                             double rightRange,
...
EXTERN int defwTracks(const char* master,
                      int doStart,
                      int doCount,
                      int doStep,
                      int numLayers,
 ...
 * Returns 0 if successful.
 * The operation of the do is explained in the documentation. */
EXTERN int defwGcellGrid(const char* master,
                         int doStart,
                         int doCount,
                         int doStep);
...
EXTERN int defwCanPlace(const char* master,
                        int xOrig,
                        int yOrig,
                        int orient,
                        int doCnt,
...
EXTERN int defwCanPlaceStr(const char* master,
                           int xOrig,
                           int yOrig,
                           const char* orient,
                           int doCnt,
 ...
 * Returns 0 if successful.
 * The routine can be called many times. */
EXTERN int defwCannotOccupy(const char* master,
                            int xOrig,
                            int yOrig,
                            int orient,
                            int doCnt,
...
EXTERN int defwCannotOccupyStr(const char* master,
                               int xOrig,
                               int yOrig,
                               const char* orient,
                               int doCnt,
...
/*  PLACED | UNPLACED             */
/* xh, yh or region               */
EXTERN int defwComponent(const char* instance,
                         const char* master,
                         int numNetName,
                         const char** netNames,
                         const char* eeq,
...
/* PLACED | UNPLACED              */
/* xh, yh or region               */
EXTERN int defwComponentStr(const char* instance,
                            const char* master,
                            int numNetName,
                            const char** netNames,
                            const char* eeq,
...
/* COVER                             */
EXTERN int defwPin(const char* name,
                   const char* net,
                   int special,
...
/* GROUND | CLOCK | TIEOFF | ANALOG  */
/* COVER                             */
EXTERN int defwPinStr(const char* name,
                      const char* net,
                      int special,
                      const char* direction,
                      const char* use,
 ...
 * The routine can be called many times.
 * NOTE: Use defwPinLayer to write out layer with SPACING or DESIGNRULEWIDTH */
EXTERN int defwPinPortLocation(const char* status,
                               int statusX,
                               int statusY,
                               const char* orient);
...
EXTERN int defwSpecialNetConnection(const char* inst,
                                    const char* pin,
                                    int synthesized);
...
EXTERN int defwSpecialNetSpacing(const char* layer,
                                 int spacing,
                                 double minwidth,
                                 double maxwidth);
...
/* x and y location of the path */
EXTERN int defwSpecialNetPathPointWithWireExt(int numPts,
                                              double* pointx,
                                              double* pointy,
                                              double* optValue);
...
/* x and y location of the path */
EXTERN int defwSpecialNetShieldPoint(int numPts,
                                     double* pointx,
                                     double* pointy);
...
/* It can be called multiple times */
EXTERN int defwNetConnection(const char* inst,
                             const char* pin,
                             int synthesized);
...
/* x and y location of the path */
EXTERN int defwNetNoshieldPoint(int numPts,
                                const char** pointx,
                                const char** pointy);
...
EXTERN int defwNetPathLayer(const char* name,
                            int isTaper,
                            const char* rulename);
 ...
 * [PARALLEL numDrivers]
 * This api is obsolete in 5.4. */
EXTERN int defwIOTimingDrivecell(const char* name,
                                 const char* fromPin,
                                 const char* toPin,
                                 int numDrivers);
...
EXTERN int defwScanchainCommonscanpins(const char* inst1,
                                       const char* pin1,
                                       const char* inst2,
                                       const char* pin2);
 ...
 * This is a 5.4.1 syntax */
EXTERN int defwScanchainFloating(const char* name,
                                 const char* inst1,
                                 const char* pin1,
                                 const char* inst2,
                                 const char* pin2);
 ...
 * the option BITS. */
EXTERN int defwScanchainFloatingBits(const char* name,
                                     const char* inst1,
                                     const char* pin1,
                                     const char* inst2,
                                     const char* pin2,
...
EXTERN int defwConstraintOperandPath(const char* comp1,
                                     const char* fromPin,
                                     const char* comp2,
                                     const char* toPin);
 ...
 * [MAXY value] */
EXTERN int defwGroupSoft(const char* type1,
                         double value1,
                         const char* type2,
                         double value2,
                         const char* type3,
