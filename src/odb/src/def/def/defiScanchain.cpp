...
defiScanchain::defiScanchain(defrData* data) : defData(data)
{
  Init();
}
...
void defiScanchain::ordered(int index,
                            int* size,
                            char*** inst,
                            char*** inPin,
                            char*** outPin,
...
void defiScanchain::floating(int* size,
                             char*** inst,
                             char*** inPin,
                             char*** outPin,
                             int** bits) const
...
void defiScanchain::print(FILE* f) const
{
  ...
  fprintf(f,
          ...
          name(),
          hasStart() + hasStop() + numFloating_ + numOrderedLists());
