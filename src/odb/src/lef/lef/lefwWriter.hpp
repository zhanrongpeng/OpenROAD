...
// Returns 0 if successful.
extern int lefwUnits(
    double time,         // optional(0) - TIME NANOSECONDS
...
// This routine is optional
// Returns 0 if successful.
extern int lefwLayerRoutingMinsize(int numRect,
                                   double* minWidth,
                                   double* minLength);
...
// This routine is optional
// Returns 0 if successful.
extern int lefwLayerRoutingMinimumcutWithin(double numCuts,
                                            double minWidth,
                                            double cutDistance);
...
// This is a 5.7 syntax.
// Returns 0 if successful.
extern int lefwLayerRoutingSpacingEOLParallel(double parSpace,
                                              double parWithin,
...
// Returns 0 if successful.
extern int lefwLayerRoutingMinenclosedarea(int numMinenclosed,
                                           double* area,
                                           double* width);
...
// This is a 5.5 syntax.
// Returns 0 if successful.
extern int lefwLayerRoutingMinstepWithOptions(
    double distance,
...
// This is a 5.5 syntax.
// Returns 0 if successful.
extern int lefwLayerRoutingProtrusion(double width1,
                                      double length,
                                      double width2);
...
// This is a 5.5 syntax.
// Returns 0 if successful.
extern int lefwLayerRoutingSpacingInfluenceWidth(double width,
                                                 double distance,
                                                 double spacing);
...
// This is a 5.7 syntax.
// Returns 0 if successful.
extern int lefwLayerRoutingSpacingtableTwoWidthsWidth(
    double width,
...
// Returns 0 if successful.
extern int lefwLayerAntennaAreaFactor(
    double value,
...
// diffUseOnly has to be DIFFUSEONLY.
// Returns 0 if successful.
extern int lefwLayerAntennaSideAreaFactor(
    double value,
    const char* diffUseOnly);  // optional(NULL)
...
// Returns 0 if successful.
// mask is 5.8 syntax
extern int lefwViaLayerPolygon(int num_polys,
                               double* xl,
                               double* yl,
                               int mask = 0);
...
// This is a 5.6 syntax.
// Returns 0 if successful.
extern int lefwViaViaruleOffset(double xBotOffset,
                                double yBotOffset,
                                double xTopOffset,
                                double yTopOffset);
...
// Returns 0 if successful.
// The direction1 or direction2 can be HORIZONTAL or VERTICAL.
extern int lefwViaRuleGenLayer3(const char* layerName,
                                double xl,
                                double yl,  // RECT pt1(x), pt1(y)
                                double xh,
                                double yh,  // RECT pt2(x), pt2(y)
                                double xSpacing,
                                double ySpacing,     // SPACING x and y
...
// This routine can be called multiple times.
// Returns 0 if successful.
extern int lefwNonDefaultRuleLayer(
    const char* routingLayerName,
    double width,          // WIDTH
...
extern int lefwNonDefaultRuleStartVia(
    const char* viaName,
    const char* isDefault);  // optional(NULL) - DEFAULT
...
extern int lefwSite(const char* siteName,
...
// Returns 0 if successful.
extern int lefwArraySite(const char* name,
                         double origX,
                         double origY,
                         int orient,
                         double numX,
...
extern int lefwArraySiteStr(const char* name,
                            double origX,
                            double origY,
                            const char* orient,
                            double numX,
...
// It can be call multiple times.
// Returns 0 if successful.
extern int lefwArrayCanplace(const char* name,
                             double origX,
                             double origY,
                             int orient,
                             double numX,
...
extern int lefwArrayCanplaceStr(const char* name,
                                double origX,
                                double origY,
                                const char* orient,
                                double numX,
...
// It can be call multiple times.
// Returns 0 if successful.
extern int lefwArrayCannotoccupy(const char* name,
                                 double origX,
                                 double origY,
                                 int orient,
                                 double numX,
...
extern int lefwArrayCannotoccupyStr(const char* name,
                                    double origX,
                                    double origY,
                                    const char* orient,
                                    double numX,
...
// It can be call multiple times.
// Returns 0 if successful.
extern int lefwArrayTracks(const char* xy,
                           double start,
                           int numTracks,
                           double space,
                           const char* layers);
...
extern int lefwArrayFloorplan(const char* site,
                              const char* name,
                              double origX,
                              double origY,
                              int orient,
...
extern int lefwArrayFloorplanStr(const char* site,
                                 const char* name,
                                 double origX,
                                 double origY,
                                 const char* orient,
...
extern int lefwArrayGcellgrid(const char* xy,
                              double startXY,
                              int colRows,
                              double spaceXY);
...
// This is a 5.6 syntax.
// Returns 0 if successful.
extern int lefwMacroDensityLayerRect(double x1,
                                     double y1,
                                     double x2,
                                     double y2,
                                     double densityValue);
...
// Either this routine or 5.4 Antenna syntax, cannot be both
// Returns 0 if successful.
extern int lefwMacroPinAntennaMetalArea(
    double value,
    const char* layerName);  // optional(NULL)
...
// Either this routine or 5.4 Antenna syntax, cannot be both
// Returns 0 if successful.
extern int lefwMacroPinAntennaMetalLength(
    double value,
    const char* layerName);  // optional(NULL)
...
// Returns 0 if successful.
extern int lefwMacroPinAntennaPartialMetalArea(
    double value,
    const char* layerName);  // optional(NULL)
...
// Either this routine or 5.3 Antenna syntax, cannot be both
// Returns 0 if successful.
extern int lefwMacroPinAntennaPartialMetalSideArea(
    double value,
    const char* layerName);  // optional(NULL)
...
// Either this routine or 5.3 Antenna syntax, cannot be both
// Returns 0 if successful.
extern int lefwMacroPinAntennaPartialCutArea(
    double value,
    const char* layerName);  // optional(NULL)
...
// Either this routine or 5.3 Antenna syntax, cannot be both
// Returns 0 if successful.
extern int lefwMacroPinAntennaDiffArea(
    double value,
    const char* layerName);  // optional(NULL)
...
// Either this routine or 5.3 Antenna syntax, cannot be both
// Returns 0 if successful.
extern int lefwMacroPinAntennaGateArea(
    double value,
    const char* layerName);  // optional(NULL)
...
// Either this routine or 5.3 Antenna syntax, cannot be both
// Returns 0 if successful.
extern int lefwMacroPinAntennaMaxAreaCar(
    double value,
    const char* layerName);  // optional(NULL)
...
// Either this routine or 5.3 Antenna syntax, cannot be both
// Returns 0 if successful.
extern int lefwMacroPinAntennaMaxSideAreaCar(
    double value,
    const char* layerName);  // optional(NULL)
...
// Either this routine or 5.3 Antenna syntax, cannot be both
// Returns 0 if successful.
extern int lefwMacroPinAntennaMaxCutCar(
    double value,
    const char* layerName);  // optional(NULL)
...
// Returns 0 if successful.
extern int lefwMacroPinPortLayerPath(int num_paths,
                                     double* xl,
                                     double* yl,
                                     int numX,       // optional(0)
                                     int numY,       // optional(0)
...
// lefwStartMacroPinPortLayerPolygon must be called.
// Returns 0 if successful.
extern int lefwMacroPinPortLayerRect(double xl1,
                                     double yl1,
                                     double xl2,
                                     double yl2,
                                     int numX,       // optional(0)
...
// Returns 0 if successful.
extern int lefwMacroPinPortVia(double xl,
                               double yl,
                               const char* viaName,
                               int numX,       // optional(0)
                               int numY,       // optional(0)
...
// Returns 0 if successful.
extern int lefwMacroObsLayerPath(int num_paths,
                                 double* xl,
                                 double* yl,
                                 int numX,       // optional(0)
                                 int numY,       // optional(0)
...
// lefwStartMacroObsLayerPolygon must be called.
// Returns 0 if successful.
extern int lefwMacroObsLayerRect(double xl1,
                                 double yl1,
                                 double xl2,
                                 double yl2,
                                 int numX,       // optional(0)
...
// Returns 0 if successful.
extern int lefwMacroObsLayerPolygon(int num_polys,
                                    double* xl,
                                    double* yl,
                                    int numX,       // optional(0)
                                    int numY,       // optional(0)
...
// must be called.
// Returns 0 if successful.
extern int lefwMacroObsVia(double xl,
                           double yl,
                           const char* viaName,
                           int numX,       // optional(0)
                           int numY,       // optional(0)
...
// This api is obsolete in 5.4.
extern int lefwMacroTimingIntrinsic(const char* riseFall,
                                    double min,
                                    double max,
