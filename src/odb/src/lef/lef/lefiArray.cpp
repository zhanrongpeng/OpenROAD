...
lefiSitePattern* lefiArrayFloorPlan::pattern(int index) const
{
  return patterns_[index];
}

char* lefiArrayFloorPlan::typ(int index) const
{
  return types_[index];
}

const char* lefiArrayFloorPlan::name() const
{
  return name_;
}
...
int lefiArray::numSitePattern() const
{
  return numPatterns_;
}

int lefiArray::numCanPlace() const
{
  return numCan_;
}

int lefiArray::numCannotOccupy() const
{
  return numCannot_;
}

int lefiArray::numTrack() const
{
  return numTracks_;
}

int lefiArray::numGcell() const
{
  return numG_;
}

int lefiArray::hasDefaultCap() const
{
  return hasDefault_;
}
...
lefiSitePattern* lefiArray::sitePattern(int index) const
{
  return pattern_[index];
}

lefiSitePattern* lefiArray::canPlace(int index) const
{
  return canPlace_[index];
}

lefiSitePattern* lefiArray::cannotOccupy(int index) const
{
  return cannotOccupy_[index];
}

lefiTrackPattern* lefiArray::track(int index) const
{
  return track_[index];
}

lefiGcellPattern* lefiArray::gcell(int index) const
{
  return gcell_[index];
}

int lefiArray::tableSize() const
{
  return tableSize_;
}

int lefiArray::numDefaultCaps() const
{
  return numDefault_;
}

int lefiArray::defaultCapMinPins(int index) const
{
  return minPins_[index];
}

double lefiArray::defaultCap(int index) const
{
  return caps_[index];
}

int lefiArray::numFloorPlans() const
{
