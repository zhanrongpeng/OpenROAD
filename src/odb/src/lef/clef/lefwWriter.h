...
/* Returns 0 if successful.                                                   */
EXTERN int lefwUnits(double time,
                     double capacitance,
                     double resistance,
                     double power,
                     double current,
...
/* This routine is called if the layer type is CUT when                       */
/* lefwStartLayer is called.                                                  */
EXTERN int lefwLayerArraySpacing(int longArray,
                                 double viaWidth,
                                 double cutSpacing,
                                 int numArrayCut,
                                 int* arrayCuts,
...
/* This routine is called if the layer type is CUT when                       */
/* lefwStartLayer is called.                                                  */
EXTERN int lefwLayerEnclosure(const char* location,
                              double overhang1,
                              double overhang2,
                              double width);
...
/* This routine is called if the layer type is CUT when                       */
/* lefwStartLayer is called.                                                  */
EXTERN int lefwLayerEnclosureWidth(const char* location,
                                   double overhang1,
                                   double overhang2,
                                   double width,
                                   double cutWithin);
...
/* This routine is called if the layer type is CUT when                       */
/* lefwStartLayer is called.                                                  */
EXTERN int lefwLayerEnclosureLength(const char* location,
                                    double overhang1,
                                    double overhang2,
                                    double minLength);
...
/* This routine is called if the layer type is CUT when                       */
/* lefwStartLayer is called.                                                  */
EXTERN int lefwLayerPreferEnclosure(const char* location,
                                    double overhang1,
                                    double overhang2,
                                    double width);
...
EXTERN int lefwIntPropDef(const char* objType,
                          const char* propName,
                          double leftRange,
                          double rightRange,
                          int propValue);
...
/* The objType can be LIBRARY or VIA or MACRO or PIN.                         */
/* NONDEFAULTRULE | MACRO | PIN         */
EXTERN int lefwRealPropDef(const char* objType,
                           const char* propName,
                           double leftRange,
                           double rightRange,
                           double propValue);
...
/* The objType can be LIBRARY or VIA or MACRO or PIN.                         */
/*  NONDEFAULTRULE | MACRO | PIN       */
EXTERN int lefwStringPropDef(const char* objType,
                             const char* propName,
                             double leftRange,
                             double rightRange,
...
/* Returns 0 if successful.                                                   */
/* mask is 5.8 syntax                                                         */
EXTERN int lefwViaLayerRect(double x1l,
                            double y1l,
                            double x2l,
                            double y2l,
                            int mask);
...
EXTERN int lefwViaRuleGenLayerEnclosure(const char* layerName,
                                        double overhang1,
                                        double overhang2,
                                        double minWidth,
                                        double maxWidth);
