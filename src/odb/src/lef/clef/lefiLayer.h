...
EXTERN double lefiLayerDensity_frequency(const lefiLayerDensity* obj,
                                         int index);
...
EXTERN double lefiLayerDensity_tableEntry(const lefiLayerDensity* obj,
                                          int index);
...
EXTERN double lefiParallel_widthSpacing(const lefiParallel* obj,
                                        int iWidth,
                                        int iWidthSpacing);
...
EXTERN double lefiTwoWidths_widthSpacing(const lefiTwoWidths* obj,
                                         int iWidth,
                                         int iWidthSpacing);
...
EXTERN const lefiInfluence* lefiSpacingTable_influence(
    const lefiSpacingTable* obj);
EXTERN int lefiSpacingTable_isParallel(const lefiSpacingTable* obj);
EXTERN const lefiParallel* lefiSpacingTable_parallel(
    const lefiSpacingTable* obj);
EXTERN const lefiTwoWidths* lefiSpacingTable_twoWidths(
    const lefiSpacingTable* obj);
...
EXTERN int lefiAntennaModel_hasAntennaDiffAreaRatio(
    const lefiAntennaModel* obj);
EXTERN int lefiAntennaModel_hasAntennaDiffAreaRatioPWL(
    const lefiAntennaModel* obj);
EXTERN int lefiAntennaModel_hasAntennaCumAreaRatio(const lefiAntennaModel* obj);
EXTERN int lefiAntennaModel_hasAntennaCumDiffAreaRatio(
    const lefiAntennaModel* obj);
EXTERN int lefiAntennaModel_hasAntennaCumDiffAreaRatioPWL(
    const lefiAntennaModel* obj);
EXTERN int lefiAntennaModel_hasAntennaAreaFactor(const lefiAntennaModel* obj);
EXTERN int lefiAntennaModel_hasAntennaAreaFactorDUO(
    const lefiAntennaModel* obj);
EXTERN int lefiAntennaModel_hasAntennaSideAreaRatio(
    const lefiAntennaModel* obj);
EXTERN int lefiAntennaModel_hasAntennaDiffSideAreaRatio(
    const lefiAntennaModel* obj);
EXTERN int lefiAntennaModel_hasAntennaDiffSideAreaRatioPWL(
    const lefiAntennaModel* obj);
EXTERN int lefiAntennaModel_hasAntennaCumSideAreaRatio(
    const lefiAntennaModel* obj);
EXTERN int lefiAntennaModel_hasAntennaCumDiffSideAreaRatio(
    const lefiAntennaModel* obj);
EXTERN int lefiAntennaModel_hasAntennaCumDiffSideAreaRatioPWL(
    const lefiAntennaModel* obj);
EXTERN int lefiAntennaModel_hasAntennaSideAreaFactor(
    const lefiAntennaModel* obj);
EXTERN int lefiAntennaModel_hasAntennaSideAreaFactorDUO(
    const lefiAntennaModel* obj);
EXTERN int lefiAntennaModel_hasAntennaCumRoutingPlusCut(
    const lefiAntennaModel* obj);
EXTERN int lefiAntennaModel_hasAntennaGatePlusDiff(const lefiAntennaModel* obj);
EXTERN int lefiAntennaModel_hasAntennaAreaMinusDiff(
    const lefiAntennaModel* obj);
EXTERN int lefiAntennaModel_hasAntennaAreaDiffReducePWL(
    const lefiAntennaModel* obj);
...
EXTERN double lefiAntennaModel_antennaDiffAreaRatio(
    const lefiAntennaModel* obj);
EXTERN const lefiAntennaPWL* lefiAntennaModel_antennaDiffAreaRatioPWL(
    const lefiAntennaModel* obj);
EXTERN double lefiAntennaModel_antennaCumAreaRatio(const lefiAntennaModel* obj);
EXTERN double lefiAntennaModel_antennaCumDiffAreaRatio(
    const lefiAntennaModel* obj);
EXTERN const lefiAntennaPWL* lefiAntennaModel_antennaCumDiffAreaRatioPWL(
    const lefiAntennaModel* obj);
EXTERN double lefiAntennaModel_antennaAreaFactor(const lefiAntennaModel* obj);
EXTERN double lefiAntennaModel_antennaSideAreaRatio(
    const lefiAntennaModel* obj);
EXTERN double lefiAntennaModel_antennaDiffSideAreaRatio(
    const lefiAntennaModel* obj);
EXTERN const lefiAntennaPWL* lefiAntennaModel_antennaDiffSideAreaRatioPWL(
    const lefiAntennaModel* obj);
EXTERN double lefiAntennaModel_antennaCumSideAreaRatio(
    const lefiAntennaModel* obj);
EXTERN double lefiAntennaModel_antennaCumDiffSideAreaRatio(
    const lefiAntennaModel* obj);
EXTERN const lefiAntennaPWL* lefiAntennaModel_antennaCumDiffSideAreaRatioPWL(
    const lefiAntennaModel* obj);
EXTERN double lefiAntennaModel_antennaSideAreaFactor(
    const lefiAntennaModel* obj);
EXTERN double lefiAntennaModel_antennaGatePlusDiff(const lefiAntennaModel* obj);
EXTERN double lefiAntennaModel_antennaAreaMinusDiff(
    const lefiAntennaModel* obj);
EXTERN const lefiAntennaPWL* lefiAntennaModel_antennaAreaDiffReducePWL(
    const lefiAntennaModel* obj);
...
EXTERN int lefiLayer_hasSpacingRangeUseLengthThreshold(const lefiLayer* obj,
                                                       int index);
EXTERN int lefiLayer_hasSpacingRangeInfluence(const lefiLayer* obj, int index);
EXTERN int lefiLayer_hasSpacingRangeInfluenceRange(const lefiLayer* obj,
                                                   int index);
...
EXTERN int lefiLayer_hasSpacingLengthThresholdRange(const lefiLayer* obj,
                                                    int index);
...
EXTERN double lefiLayer_spacingRangeInfluenceMin(const lefiLayer* obj,
                                                 int index);
EXTERN double lefiLayer_spacingRangeInfluenceMax(const lefiLayer* obj,
                                                 int index);
...
EXTERN double lefiLayer_spacingLengthThresholdRangeMin(const lefiLayer* obj,
                                                       int index);
EXTERN double lefiLayer_spacingLengthThresholdRangeMax(const lefiLayer* obj,
                                                       int index);
...
EXTERN double lefiLayer_spacingEndOfNotchSpacing(const lefiLayer* obj,
                                                 int index);
EXTERN double lefiLayer_spacingEndOfNotchLength(const lefiLayer* obj,
                                                int index);
...
EXTERN const char* lefiLayer_minimumcutConnection(const lefiLayer* obj,
                                                  int index);
...
EXTERN void lefiLayer_currentDensityArray(const lefiLayer* obj,
                                          int* numPoints,
                                          double** widths,
                                          double** current);
EXTERN void lefiLayer_capacitanceArray(const lefiLayer* obj,
                                       int* numPoints,
                                       double** widths,
                                       double** resValues);
EXTERN void lefiLayer_resistanceArray(const lefiLayer* obj,
                                      int* numPoints,
                                      double** widths,
                                      double** capValues);

EXTERN int lefiLayer_numAccurrentDensity(const lefiLayer* obj);
EXTERN const lefiLayerDensity* lefiLayer_accurrent(const lefiLayer* obj,
                                                   int index);
EXTERN int lefiLayer_numDccurrentDensity(const lefiLayer* obj);
EXTERN const lefiLayerDensity* lefiLayer_dccurrent(const lefiLayer* obj,
                                                   int index);
...
EXTERN const lefiAntennaModel* lefiLayer_antennaModel(const lefiLayer* obj,
                                                      int index);
...
EXTERN int lefiLayer_hasEnclosureExceptExtraCut(const lefiLayer* obj,
                                                int index);
EXTERN double lefiLayer_enclosureExceptExtraCut(const lefiLayer* obj,
                                                int index);
...
EXTERN double lefiLayer_preferEnclosureOverhang1(const lefiLayer* obj,
                                                 int index);
EXTERN double lefiLayer_preferEnclosureOverhang2(const lefiLayer* obj,
                                                 int index);
EXTERN int lefiLayer_hasPreferEnclosureWidth(const lefiLayer* obj, int index);
EXTERN double lefiLayer_preferEnclosureMinWidth(const lefiLayer* obj,
                                                int index);
