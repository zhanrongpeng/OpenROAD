...
EXTERN enum lefiGeomEnum lefiGeometries_itemType(const lefiGeometries* obj,
                                                 int index);
EXTERN struct lefiGeomRect* lefiGeometries_getRect(const lefiGeometries* obj,
                                                   int index);
EXTERN struct lefiGeomRectIter* lefiGeometries_getRectIter(
    const lefiGeometries* obj,
    int index);
EXTERN struct lefiGeomPath* lefiGeometries_getPath(const lefiGeometries* obj,
                                                   int index);
EXTERN struct lefiGeomPathIter* lefiGeometries_getPathIter(
    const lefiGeometries* obj,
    int index);
EXTERN int lefiGeometries_hasLayerExceptPgNet(const lefiGeometries* obj,
                                              int index);
EXTERN char* lefiGeometries_getLayer(const lefiGeometries* obj, int index);
EXTERN double lefiGeometries_getLayerMinSpacing(const lefiGeometries* obj,
                                                int index);
EXTERN double lefiGeometries_getLayerRuleWidth(const lefiGeometries* obj,
                                               int index);
EXTERN double lefiGeometries_getWidth(const lefiGeometries* obj, int index);
EXTERN struct lefiGeomPolygon* lefiGeometries_getPolygon(
    const lefiGeometries* obj,
    int index);
EXTERN struct lefiGeomPolygonIter* lefiGeometries_getPolygonIter(
    const lefiGeometries* obj,
    int index);
EXTERN char* lefiGeometries_getClass(const lefiGeometries* obj, int index);
EXTERN struct lefiGeomVia* lefiGeometries_getVia(const lefiGeometries* obj,
                                                 int index);
EXTERN struct lefiGeomViaIter* lefiGeometries_getViaIter(
    const lefiGeometries* obj,
    int index);
...
EXTERN const char* lefiTrackPattern_layerName(const lefiTrackPattern* obj,
                                              int index);
...
EXTERN const char* lefiMaxStackVia_maxStackViaBottomLayer(
    const lefiMaxStackVia* obj);
EXTERN const char* lefiMaxStackVia_maxStackViaTopLayer(
    const lefiMaxStackVia* obj);
