...
EXTERN const lefiGeometries* lefiObstruction_geometries(
    const lefiObstruction* obj);

EXTERN void lefiObstruction_print(const lefiObstruction* obj, FILE* f);

/* 5.5                                                                        */

EXTERN int lefiPinAntennaModel_hasAntennaGateArea(
    const lefiPinAntennaModel* obj);
EXTERN int lefiPinAntennaModel_hasAntennaMaxAreaCar(
    const lefiPinAntennaModel* obj);
EXTERN int lefiPinAntennaModel_hasAntennaMaxSideAreaCar(
    const lefiPinAntennaModel* obj);
EXTERN int lefiPinAntennaModel_hasAntennaMaxCutCar(
    const lefiPinAntennaModel* obj);

EXTERN char* lefiPinAntennaModel_antennaOxide(const lefiPinAntennaModel* obj);

EXTERN int lefiPinAntennaModel_numAntennaGateArea(
    const lefiPinAntennaModel* obj);
EXTERN double lefiPinAntennaModel_antennaGateArea(
    const lefiPinAntennaModel* obj,
    int index);
EXTERN const char* lefiPinAntennaModel_antennaGateAreaLayer(
    const lefiPinAntennaModel* obj,
    int index);

EXTERN int lefiPinAntennaModel_numAntennaMaxAreaCar(
    const lefiPinAntennaModel* obj);
EXTERN double lefiPinAntennaModel_antennaMaxAreaCar(
    const lefiPinAntennaModel* obj,
    int index);
EXTERN const char* lefiPinAntennaModel_antennaMaxAreaCarLayer(
    const lefiPinAntennaModel* obj,
    int index);

EXTERN int lefiPinAntennaModel_numAntennaMaxSideAreaCar(
    const lefiPinAntennaModel* obj);
EXTERN double lefiPinAntennaModel_antennaMaxSideAreaCar(
    const lefiPinAntennaModel* obj,
    int index);
EXTERN const char* lefiPinAntennaModel_antennaMaxSideAreaCarLayer(
    const lefiPinAntennaModel* obj,
    int index);

EXTERN int lefiPinAntennaModel_numAntennaMaxCutCar(
    const lefiPinAntennaModel* obj);
EXTERN double lefiPinAntennaModel_antennaMaxCutCar(
    const lefiPinAntennaModel* obj,
    int index);
EXTERN const char* lefiPinAntennaModel_antennaMaxCutCarLayer(
    const lefiPinAntennaModel* obj,
    int index);
...
EXTERN const char* lefiPin_antennaMetalLengthLayer(const lefiPin* obj,
                                                   int index);
...
EXTERN const char* lefiPin_antennaPartialMetalAreaLayer(const lefiPin* obj,
                                                        int index);

EXTERN int lefiPin_numAntennaPartialMetalSideArea(const lefiPin* obj);
EXTERN double lefiPin_antennaPartialMetalSideArea(const lefiPin* obj,
                                                  int index);
EXTERN const char* lefiPin_antennaPartialMetalSideAreaLayer(const lefiPin* obj,
                                                            int index);
...
EXTERN const char* lefiPin_antennaPartialCutAreaLayer(const lefiPin* obj,
                                                      int index);
...
EXTERN const lefiPinAntennaModel* lefiPin_antennaModel(const lefiPin* obj,
                                                       int index);
...
EXTERN struct lefiGeomRect lefiDensity_getRect(const lefiDensity* obj,
                                               int index,
                                               int rectIndex);
EXTERN double lefiDensity_densityValue(const lefiDensity* obj,
                                       int index,
                                       int rectIndex);
...
EXTERN void lefiMacro_generate(const lefiMacro* obj,
                               char** name1,
                               char** name2);
EXTERN const lefiSitePattern* lefiMacro_sitePattern(const lefiMacro* obj,
                                                    int index);
