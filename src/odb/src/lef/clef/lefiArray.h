...
EXTERN const lefiSitePattern* lefiArrayFloorPlan_pattern(
...
EXTERN const lefiSitePattern* lefiArray_sitePattern(const lefiArray* obj,
                                                    int index);
EXTERN const lefiSitePattern* lefiArray_canPlace(const lefiArray* obj,
                                                 int index);
EXTERN const lefiSitePattern* lefiArray_cannotOccupy(const lefiArray* obj,
                                                     int index);
...
EXTERN const char* lefiArray_siteType(const lefiArray* obj,
                                      int floorIndex,
                                      int siteIndex);
EXTERN const lefiSitePattern* lefiArray_site(const lefiArray* obj,
                                             int floorIndex,
                                             int siteIndex);
