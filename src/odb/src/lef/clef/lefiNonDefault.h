...
EXTERN const char* lefiNonDefault_propName(const lefiNonDefault* obj,
                                           int index);
...
EXTERN const char* lefiNonDefault_layerName(const lefiNonDefault* obj,
                                            int index);
...
EXTERN int lefiNonDefault_hasLayerWireExtension(const lefiNonDefault* obj,
                                                int index);
EXTERN double lefiNonDefault_layerWireExtension(const lefiNonDefault* obj,
                                                int index);
EXTERN int lefiNonDefault_hasLayerResistance(const lefiNonDefault* obj,
                                             int index);
EXTERN double lefiNonDefault_layerResistance(const lefiNonDefault* obj,
                                             int index);
EXTERN int lefiNonDefault_hasLayerCapacitance(const lefiNonDefault* obj,
                                              int index);
EXTERN double lefiNonDefault_layerCapacitance(const lefiNonDefault* obj,
                                              int index);
...
EXTERN int lefiNonDefault_hasLayerDiagWidth(const lefiNonDefault* obj,
                                            int index);
EXTERN double lefiNonDefault_layerDiagWidth(const lefiNonDefault* obj,
                                            int index);
...
EXTERN const lefiVia* lefiNonDefault_viaRule(const lefiNonDefault* obj,
                                             int index);
...
EXTERN const lefiSpacing* lefiNonDefault_spacingRule(const lefiNonDefault* obj,
                                                     int index);
...
EXTERN const char* lefiNonDefault_viaRuleName(const lefiNonDefault* obj,
                                              int index);
EXTERN int lefiNonDefault_numMinCuts(const lefiNonDefault* obj);
EXTERN const char* lefiNonDefault_cutLayerName(const lefiNonDefault* obj,
                                               int index);
