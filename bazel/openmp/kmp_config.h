...
#define OMPD_SUPPORT 0
#define OMPX_TASKGRAPH 0
#define OMP_PROFILING_SUPPORT 0
...
#define KMP_HAVE_WAITPKG_INTRINSICS 0
#define KMP_HAVE_RTM_INTRINSICS 0
#define KMP_HAVE_IMMINTRIN_H 0
#define KMP_HAVE_INTRIN_H 0
#define KMP_HAVE_ATTRIBUTE_WAITPKG 0
#define KMP_HAVE_ATTRIBUTE_RTM 0
#define KMP_ARCH_AARCH64_A64FX 0
#define KMP_HAVE_XMMINTRIN_H 0
#define KMP_HAVE__MM_MALLOC 0
#define KMP_HAVE_ALIGNED_ALLOC 0
#define KMP_HAVE_POSIX_MEMALIGN 0
#define KMP_HAVE__ALIGNED_MALLOC 0
#define ENABLE_LIBOMPTARGET 0
